...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[5]); // line circom 61
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[2];
// load src
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[5]); // line circom 62
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[3];
// load src
...
Fr_lt(&expaux[0],&lvar[3],&lvar[2]); // line circom 63
while(Fr_isTrue(&expaux[0])){
{
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[0])) + 324)]].signalStart + 0],&circuitConstants[1]); // line circom 67
...
PFrElement aux_dest = &lvar[0];
// load src
Fr_add(&expaux[0],&lvar[0],&circuitConstants[2]); // line circom 68
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[3];
// load src
Fr_add(&expaux[0],&lvar[3],&circuitConstants[2]); // line circom 63
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[3],&lvar[2]); // line circom 63
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_add(&expaux[0],&lvar[2],&circuitConstants[2]); // line circom 62
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[5]); // line circom 62
...
PFrElement aux_dest = &lvar[1];
// load src
Fr_add(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 61
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[5]); // line circom 61
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[5]); // line circom 82
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[3];
// load src
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[5]); // line circom 83
while(Fr_isTrue(&expaux[0])){
{
...
Fr_lt(&expaux[0],&lvar[4],&lvar[2]); // line circom 84
while(Fr_isTrue(&expaux[0])){
{
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 648)]].signalStart + 0],&circuitConstants[1]); // line circom 88
...
PFrElement aux_dest = &lvar[3];
// load src
Fr_add(&expaux[0],&lvar[3],&circuitConstants[2]); // line circom 83
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[5]); // line circom 83
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[5]); // line circom 103
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[4];
// load src
...
Fr_lt(&expaux[0],&lvar[4],&circuitConstants[5]); // line circom 104
while(Fr_isTrue(&expaux[0])){
{
...
Fr_add(&expaux[2],&lvar[3],&circuitConstants[6]); // line circom 105
Fr_lt(&expaux[0],&lvar[5],&expaux[2]); // line circom 105
while(Fr_isTrue(&expaux[0])){
{
...
Fr_add(&expaux[2],&lvar[4],&circuitConstants[6]); // line circom 106
Fr_lt(&expaux[0],&lvar[6],&expaux[2]); // line circom 106
while(Fr_isTrue(&expaux[0])){
{
...
Fr_leq(&expaux[0],&lvar[7],&lvar[5]); // line circom 107
while(Fr_isTrue(&expaux[0])){
{
...
Fr_lt(&expaux[0],&lvar[8],&lvar[6]); // line circom 108
while(Fr_isTrue(&expaux[0])){
{
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[2])) + 972)]].signalStart + 0],&circuitConstants[1]); // line circom 112
...
PFrElement aux_dest = &lvar[8];
// load src
Fr_add(&expaux[0],&lvar[8],&circuitConstants[2]); // line circom 108
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[8],&lvar[6]); // line circom 108
...
PFrElement aux_dest = &lvar[7];
// load src
Fr_add(&expaux[0],&lvar[7],&circuitConstants[2]); // line circom 107
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_leq(&expaux[0],&lvar[7],&lvar[5]); // line circom 107
...
PFrElement aux_dest = &lvar[6];
// load src
Fr_add(&expaux[0],&lvar[6],&circuitConstants[2]); // line circom 106
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_add(&expaux[2],&lvar[4],&circuitConstants[6]); // line circom 106
...
PFrElement aux_dest = &lvar[4];
// load src
Fr_add(&expaux[0],&lvar[4],&circuitConstants[6]); // line circom 104
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[4],&circuitConstants[5]); // line circom 104
...
PFrElement aux_dest = &lvar[3];
// load src
Fr_add(&expaux[0],&lvar[3],&circuitConstants[6]); // line circom 103
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[5]); // line circom 103
