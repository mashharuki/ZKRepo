...
contract TokenRegistry is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function initialize() initializer public {
        ...
        chainIdOfName["scrollTestnet"] = 534351;
    }
    ...
    function getTokenAddress(uint256 chainId, string memory tokenName) public view returns (address) {
        ...
        if (Strings.equal(tokenName, "WETH")) {
            ...
            if (chainId == 534351) return 0x5300000000000000000000000000000000000004;
        }
        ...
        if (Strings.equal(tokenName, "DAI")) {
            ...
            if (chainId == 534351) return 0xFa94dA175bE505B915187EdC8aE2f62F4Ccbf848;
        }
        ...
        if (Strings.equal(tokenName, "USDC")) {
            ...
            if (chainId == 534351) return 0x29A840dEcF91547DB4ed77F1E59542C4d1986915;
        }
